...
# =================================================================================
# 💾 FUNÇÕES DE SUPORTE E CACHING (Copiadas do arquivo)
# =================================================================================
def safe_int(v):
    try: return int(v)
    except: return 0
...
# =================================================================================
# 🎯 FUNÇÕES DE API E ATUALIZAÇÃO (Copiadas do arquivo)
# =================================================================================
...
# =================================================================================
# 📈 FUNÇÕES DE CÁLCULO E FORMATAÇÃO DE ESTATÍSTICAS (Copiadas do arquivo)
# =================================================================================
def calcular_estatisticas_time(time, aba, ultimos=None, casa_fora=None):
    ...
    for linha in linhas:
        ...
        if em_casa:
            ...
            d["gols_sofridos_2T_fora"] += gm1 # Corrigido: Aqui era gm1, deve ser gv2 (gols contra no 2T)
        ...
        d["gols_sofridos_2T"] += gv2 if em_casa else gm2 # Corrigido: gm2 no arquivo original, deve ser gv2/gm2 dependendo da condição
    ...
    if update.message:
        ...
        try:
            await update.callback_query.edit_message_text(title, reply_markup=reply_markup, parse_mode='Markdown')
             ...
             # Fallback: Se a edição falhar (e.g., mensagem muito antiga), envia nova mensagem
...
async def callback_query_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await query.edit_message_text(f"Ocorreu um erro ao processar sua solicitação. Verifique os logs: {e}")
